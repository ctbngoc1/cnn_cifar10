...
The dataset was split into 45,000 images for training, 5000 images for validation, and 10,000 images for testing. Image pixel values were normalized to the range [0,1] to improve numerical stability during training.
